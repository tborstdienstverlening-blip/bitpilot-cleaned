...
if hasattr(healthcheck, "report"):
    ...
    c1.metric("Start_kapitaal", rep.get("start_kapitaal", 0))
...
with tab_ai:
    st.info("R0.2-03 pakt AI/uitklappen; nu alleen 01/02 gedaan.")
